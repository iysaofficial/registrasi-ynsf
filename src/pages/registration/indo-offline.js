...
function IndonesiaOffline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Youth National Science Fair - Offline Competition":
        break;
      default:
        break;
    }
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbxXUdcE9PqzSkmnEylGDJAaiBslnRfui4fAJUrVXgX2FA_AyM9fEYI2N4jUwsfJ4qf7BQ/exec";
  ...
  return (
    <>
      <Head>
        <title>Indo Offline | YNSF</title>
        <meta name="description" content="Halaman Registrasi YNSF" />
      </Head>
        ...
        <div class="container">
          <div class="content">
            ...
            <h4 className="text-xl">
              HALLO PESERTA YNSF 2026, Mohon perhatikan informasi berikut ini
              sebelum mengisi formulir pendaftaran :
            </h4>
            <br />
            <p>
              1. Mohon mengisi data yang diperlukan dengan benar dan memastikan
              tidak ada kesalahan penulisan. Pastikan jugaZ bahwa data yang
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    <option value="Youth National Science Fair - Offline Competition">
                      Offline Competition
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    Sumber Informasi Kompetisi YNSF 2026
                  </label>
                  <select
                    type="text"
